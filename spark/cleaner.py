...
class DataCleaner:
    ...
    def clean(self):
        ...
        # str -> Double
        numeric_cols = ["DEP_DELAY", "ARR_DELAY", "DISTANCE", "TAXI_OUT", "TAXI_IN", "CRS_ELAPSED_TIME", "ACTUAL_ELAPSED_TIME", "CARRIER_DELAY", "WEATHER_DELAY",
        ...
        # fillna
        self.df = self.df.fillna(0.0, subset=["CARRIER_DELAY", "WEATHER_DELAY",
